...
import { Button, Card, FormFeedback, FormGroup, FormText, Input, Label, Spinner } from 'reactstrap';
...
import { bindProductDeveloperBasicInfo, productDeveloperImageUpload, updateBuyerProductDeveloper } from '../store/actions';
const BuyerProductDeveloperEditForm = ( { open, toggleSidebarForEdit } ) => {
    ...
    const onSubmit = () => {
        const submitObj = {
            id: productDeveloperBasicInfo.id,
        ...
        dispatch( updateBuyerProductDeveloper( submitObj, productDeveloperBasicInfo.id ) );
                    ...
                    <div className="main-div">
                        <Card className="img-holder">
                            ...
                            {isProDevImageUploading ? <div
                                ...
                                src={productDeveloperBasicInfo.imageEditUrl.length ? `${productDeveloperBasicInfo.imageEditUrl}` : productDeveloperBasicInfo.imageUrl.length ? `${productDeveloperBasicInfo.imageUrl}` : defaultImage}
                            ...
                            <div className="overlay" >
                                <div className="text">
                                    <Button.Ripple
                                        ...
                                        hidden={!productDeveloperBasicInfo.imageUrl.length}
                                    ...
                                    <Button.Ripple
                                        tag={Label}
                                        hidden={!productDeveloperBasicInfo.imageEditUrl.length}
