...
import { addBuyerProductDeveloper, bindProductDeveloperBasicInfo, productDeveloperImageUpload } from '../store/actions';
...
const BuyerProductDeveloperAddForm = ( { open, toggleSidebar } ) => {
    ...
    const onSubmit = () => {
        ...
        dispatch( addBuyerProductDeveloper( submitObj ) );
    };
