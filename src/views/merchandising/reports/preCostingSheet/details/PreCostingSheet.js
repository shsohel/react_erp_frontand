...
const PreCostingSheet = () => {
  ...
  return (
    <div className="p-1 mt-3">
      <ActionMenu title="Post-Costing Sheet" moreButton={false} breadcrumb={breadcrumb}>
                ...
                <Col xs={12}>
                  <Row className="d-flex justify-content-between">
                    <div>
                      ...
                      <span>{` ${preCostingSheets?.reportGeneratedOn ? preCostingSheets?.reportGeneratedOn : ""}`}</span>
                    </div>
                    <div>
                      <Label className="h5">User: </Label>
                      <span>{` ${preCostingSheets?.user ? preCostingSheets?.user : ""}`}</span>
                    </div>
                  </Row>
                </Col>
              </Card>
