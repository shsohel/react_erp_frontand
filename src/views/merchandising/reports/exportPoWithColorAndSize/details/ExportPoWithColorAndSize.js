                  ...
                  <Col xs={12}>
                    <Row className="d-flex justify-content-between">
                      <div>
                        ...
                        <span>{` ${exportPoWithColorAndSizes?.reportGeneratedOn ? exportPoWithColorAndSizes?.reportGeneratedOn : ''}`}</span>
                      </div>
                      <div>
                        <Label className="h5">User: </Label>
                        <span>{` ${exportPoWithColorAndSizes?.user ? exportPoWithColorAndSizes?.user : ''}`}</span>
                      </div>
                    </Row>
                  </Col>
                </Row>
