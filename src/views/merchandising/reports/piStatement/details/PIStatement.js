        ...
        <Row>
          <Col xs="12" sm="12" md="12" lg="12" xl="12">
            <Row className="border rounded rounded-3 mr-1">
              ...
              {/* Clear Button start */}
              <FormGroup tag={Col} xs={12} sm={6} md={4} lg={1} xl={1}>
                <Button size="sm" color="warning" className="mt-2" onClick={onClear}>
                  Clear
                </Button>
              </FormGroup>
              {/* Clear Button end */}
                  ...
                  <Col xs={12}>
                    <Row className="d-flex justify-content-between">
                      <div>
                        ...
                        <span>{` ${ipiStatement?.reportGeneratedOn ? ipiStatement?.reportGeneratedOn : ''}`}</span>
                      </div>
                      <div>
                        <Label className="h5">User: </Label>
                        <span>{` ${ipiStatement?.user ? ipiStatement?.user : ''}`}</span>
                      </div>
                    </Row>
                  </Col>
                </Row>
