                        ...
                        {materailStatusStyleAndPoWise?.map( ( po, index ) => (
                          <Fragment key={uuid()}>
                            <tr>
                              ...
                              <td>{po.bomQuantity}</td>
                              <td className="text-center">{po.bomUom}</td>
                              <td>{po.supplierOrderQuantity}</td>
                              <td>{po.spidQuantity}</td>
                            </tr>
                            <tr>
                                    ...
                                    <tbody>
                                      {po.itemDetails?.map( item => (
                                        <tr key={uuid()} className="text-right">
                                          ...
                                          <td>{item.supplierOrderQuantity}</td>
                                          <td>{item.spidQuantity}</td>
                                        </tr>
                                      ) )}
                                    </tbody>
                                  </Table>
                  ...
                  <Col xs={12}>
                    <Row className="d-flex justify-content-between">
                      <div>
                        ...
                        <span>{` ${materailStatusStyleAndPoWise?.reportGeneratedOn ? materailStatusStyleAndPoWise?.reportGeneratedOn : ''}`}</span>
                      </div>
                      <div>
                        <Label className="h5">User: </Label>
                        <span>{` ${materailStatusStyleAndPoWise?.user ? materailStatusStyleAndPoWise?.user : ''}`}</span>
                      </div>
                    </Row>
                  </Col>
                </Row>
