...
const SingleStylePhotoUploadModal = ( { openModal, setOpenModal, handlePhotoAddToTable, photos, handlePhotoRemoveFromTable, handleDefaultPhotoOnTable, handlePhotoUploadToCarousel } ) => {
...
export default SingleStylePhotoUploadModal;