...
const ProcurementItemDetails = () => {
    ...
    console.log( filterObj.balanceToRaised );
                            ...
                            columns={[
                                    ...
                                    name:
                                        <>
                                            <CustomInput
                                                ...
                                                id="isSelectedIdDetails"
                                                name='isSelectedAll'
                                                htmlFor="isSelectedIdDetails"
                                ...
                                },
                                {
                                    ...
                                    cell: row => <Select
                                        id='orderUom'
                                        name="orderUom"
                                        isDisabled={handleItemExitingWithMinQtyValue( row )}
                                        isSearchable
                                        menuPosition="fixed"
                                        ...
                                        value={row.orderUom}
                                        onChange={( data, e ) => {
                                            handleControlDropdownChange( data, e, row );
                                        }}
                                        onFocus={() => {
                                            handleOrderUomDropdownOnFocus(
                                                dropDownItemGroups?.find( item => item.value === row.itemGroupId )?.defaultUomSetId, row.uoms, row.rowId
                                            );
                                        }}
                                    />
                                },
