...
import { bindProcurementBasicInfo } from '../store/actions';

const SupplierModal = ( { openModal, setOpenModal, searchFor = "procurement-details" } ) => {
            ...
            >
                ...
                <DataTable
                    ...
                    conditionalRowStyles={[
                        {
                            when: row => row.value === procurementBasicInfo?.supplier?.value,
                            style: {
