...
import { ChevronDown, ChevronUp, MinusSquare, MoreHorizontal, Settings } from 'react-feather';
...
import { Button, Card, CardBody, Col, Collapse, Form, FormFeedback, InputGroup, InputGroupAddon, InputGroupText, Label, NavItem, NavLink, Row, Table } from 'reactstrap';
...
import { confirmObj, costingStatus, defaultUnitId } from '../../../../utility/enums';
...
const CostingCloneForm = () => {
    ...
    return (
        <div>
            ...
            {isCostingDataProgress ? <Spinner /> : ( <Card className="mt-3 costing-form">
                <CardBody>
                    <Form >
                        <Row >
                            <Col>
                                                ...
                                                <div className=' border rounded pt-0 pr-1 pb-1 pl-1 costing-custom-table' >
                                                    ...
                                                    <Table responsive bordered size="sm">
                                                        ...
                                                        <tbody className='text-center' >
                                                            ...
                                                            <tr hidden={costingBasicInfo?.styleOrderDetails.length}>
...
export default CostingCloneForm;
