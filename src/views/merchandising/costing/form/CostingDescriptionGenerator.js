...
const CostingDescriptionGenerator = ( { descriptionModalObj, openModal, setOpenModal } ) => {
                    ...
                    <div style={{ minHeight: '200px' }}>
                        <Row className=''>
                            <Col className='item-segment-custom-table' xs={12} sm={12} md={12} lg={12} xl={12}>
                                ...
                                <Table className="text-center mt-1" bordered>
                                    <thead>
                                        <tr>
                                            <th>Segment</th>
                                            <th>Value</th>
...
export default CostingDescriptionGenerator;
