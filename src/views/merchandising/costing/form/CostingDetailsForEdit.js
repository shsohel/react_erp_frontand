...
import { confirmObj, costingConsumptionBodyParts } from '../../../../utility/enums';
import { insertAfterItemOfArray, isZeroToFixed, randomIdGenerator, selectThemeColors } from '../../../../utility/Utils';
...
import CostingDescriptionGeneratorEdit from './CostingDescriptionGeneratorEdit';
const CostingDetailsForEdit = () => {
    ...
    const handleItemSubGroupDropdownOnFocusForFabric = async ( itemGroupId, fieldId, itemSubGroups ) => {
        if ( !itemSubGroups.length ) {
            if ( itemGroupId ) {

                const updatedData = costingFabricDetails.map( i => {
                    if ( fieldId === i.fieldId ) {
                        i.itemSubGroupArray = [];
                        i.isItemSubGroupLoaded = false;
                    }
                    return i;
                } );
                dispatch( bindCostingFabricDetails( updatedData ) );

                await baseAxios.get( `${inventoryApi.itemGroup.root}/${itemGroupId}/subCategories` )
                    .then( response => {
                        const updatedData = costingFabricDetails.map( i => {
                            if ( fieldId === i.fieldId ) {
    ...
    const handleConsumptionUOMOnFocusForFabric = ( defaultUomSetId, uomArray, fieldId ) => {
        if ( !uomArray.length && defaultUomSetId ) {
            ...
            const updatedData = costingFabricDetails.map( i => {
                if ( fieldId === i.fieldId ) {
                    i.consumptionUOMArray = [];
                    i.isConsumptionUomLoaded = false;
                }
                return i;
            } );
    ...
    const handleItemDescriptionOnFocus = ( itemGroupId, ItemSubGroupId, fabricFieldId, itemDescriptions ) => {
        if ( !itemDescriptions.length ) {
            ...
            const updatedData = costingFabricDetails.map( i => {
                if ( fabricFieldId === i.fieldId ) {
                    i.itemDescriptionArray = [];
                    i.isItemDescriptionLoaded = false;
                }
                return i;
            } );
            dispatch( bindCostingFabricDetails( updatedData ) );
            ...
            baseAxios.get( endPoint ).then( response => {
                const updatedData = costingFabricDetails.map( i => {
                    if ( fabricFieldId === i.fieldId ) {
                        ...
                        i.isItemDescriptionLoaded = true;
                    }
                    return i;
                } );
                dispatch( bindCostingFabricDetails( updatedData ) );
    ...
    const handleItemSubGroupDropdownOnFocusForAccessories = async ( itemGroupId, fieldId, itemSubGroups ) => {
        if ( !itemSubGroups.length ) {
            if ( itemGroupId ) {
                const updatedData = costingAccessoriesDetails.map( i => {
                    if ( fieldId === i.fieldId ) {
            ...
            </Nav>
            {
                active === '1' && <div>
                                        ...
                                        <tr key={i.fieldId} >
                                            ...
                                            <td style={{ width: '105px' }} >
                                                <Select
                                                    ...
                                                    options={_.sortBy( dropDownFabricItemGroups, 'label' )}
                                            ...
                                            <td  >
                                                <Select
                                                    ...
                                                    //  menuPlacement="top"
                                                    isSearchable
                                                    isLoading={!i.isItemSubGroupLoaded}
                                                    theme={selectThemeColors}
                                                    menuPosition={'fixed'}
                                                    maxMenuHeight={200}

                                                    options={_.sortBy( i.itemSubGroupArray, 'label' )}
                                                    classNamePrefix="dropdown"
                                                    className={classnames( `erp-dropdown-select ${( ( i.isFieldError && !i.itemSubGroup ) ) && 'is-invalid'}` )}
                                                    value={i.itemSubGroup}
                                                    onFocus={() => { handleItemSubGroupDropdownOnFocusForFabric( i?.itemGroupId, i.fieldId, i.itemSubGroupArray ); }}
                                                    onChange={data => {
                                            ...
                                            <td style={{ minWidth: '405px' }} >
                                                <div className="d-flex w-100  align-items-center">
                                                    <Select
                                                        isLoading={!i.isItemDescriptionLoaded}
                                                        ...
                                                        onFocus={() => { handleItemDescriptionOnFocus( i?.itemGroupId, i?.itemSubGroupId, i.fieldId, i.itemDescriptionArray ); }}
                                                    />
                                                    <span >
                                                        <Button.Ripple
                                            ...
                                            <td style={{ width: '105px' }} >
                                                <Select
                                                    ...
                                                    isLoading={!i.isConsumptionUomLoaded}
                                                    isClearable={false}
                                                    isSearchable
                                                    menuPosition={'fixed'}
                                                    maxMenuHeight={200}
                                            ...
                                            <td style={{ width: '105px' }} >
                                                <NumberFormat
                                                    ...
                                                    decimalScale={6}
                                                    fixedDecimalScale={i.consumptionRatePerUnit > 0}
                                                    allowNegative={false}
                                                    allowLeadingZeros={false}
                                                    onFocus={e => {
                                                        e.target.select();
                                            ...
                                            <td style={{ width: '105px' }}>
                                                <Input
                                                    ...
                                                    disabled
                                                    name="totalCost"
                                                    value={isZeroToFixed( i.totalCost, 6 )}
                                                    placeholder="0"
                                                    onChange={e => { handleOnChangeForFabric( e, i.fieldId ); }}
                                            ...
                                            <td style={{ width: '105px' }}>
                                                <NumberFormat
                                                    ...
                                                    decimalScale={6}
                                                    fixedDecimalScale={i.inHouseConsumption > 0}
                                                    allowNegative={false}
                                                    allowLeadingZeros={false}
                                                    onFocus={e => {
                                                        e.target.select();
                                            ...
                                            <td style={{ width: '105px' }} >
                                                <NumberFormat
                                                    ...
                                                    decimalScale={6}
                                                    fixedDecimalScale={i.inHouseRatePerUnit > 0}
                                                    allowNegative={false}
                                                    allowLeadingZeros={false}
                                                    onFocus={e => {
                                                        e.target.select();
                                            ...
                                            <td style={{ width: '105px' }} >
                                                <Input
                                                    ...
                                                    value={isZeroToFixed( i.inHouseCostPerUnit, 6 )}
                                                    placeholder="0"
                                                    disabled
                                                    onChange={e => { handleOnChangeForFabric( e, i.fieldId ); }}
                                                    onFocus={e => { e.target.select(); }}
                    ...
                    </div>
                    {
                        ...
                        <CostingDescriptionGeneratorEdit
                                        ...
                                        <tr key={i.fieldId} >
                                            ...
                                            <td  >
                                                <Select
                                                    ...
                                                    menuPosition={'fixed'}
                                                    theme={selectThemeColors}
                                                    options={_.sortBy( dropDownTrimItemGroups, 'label' )}
                                                    classNamePrefix='dropdown'
                                                    className={classnames( `erp-dropdown-select ${( ( i.isFieldError && !i.itemGroup ) ) && 'is-invalid'}` )}
                                                    value={i.itemGroup}
                                                    onChange={data => {
                                            ...
                                            <td  >
                                                <Select
                                                    ...
                                                    className={classnames( `erp-dropdown-select ${( ( i.isFieldError && !i.itemSubGroup ) ) && 'is-invalid'}` )}
                                                    value={i.itemSubGroup}
                                                    onFocus={() => { handleItemSubGroupDropdownOnFocusForAccessories( i?.itemGroupId, i.fieldId, i.itemSubGroupArray ); }}
                                                    onChange={data => {
                                            ...
                                            <td style={{ width: '105px' }} >
                                                <Select
                                                    ...
                                                    className={classnames( `erp-dropdown-select ${( ( i.isFieldError && !i.consumptionUOMValue ) ) && 'is-invalid'}` )}
                                                    value={i.consumptionUOMValue}
                                                    onFocus={() => { handleConsumptionUOMOnFocusAccessories( dropDownTrimItemGroups?.find( item => item.value === i.itemGroupId )?.defaultUomSetId, i.consumptionUOMArray, i.fieldId ); }}
                                                    onChange={data => {
...
export default CostingDetailsForEdit;
