...
import CostingDecisionModal from './CostingDecisionModal';
...
const selectPO = [
    { value: 'PO-645', label: "PO-645" },
    { value: 'PO-700', label: "PO-700" },
    { value: 'PO-600', label: "PO-600" }
];
...
const CostingAddFormFromExiting = () => {
    ...
    const [buyerPO, setBuyerPO] = useState( null );
    ...
    const handleCostingDecisionModal = () => {
        setDecisionModalOpen( !decisionModalOpen );
    };
    ...
    return (
        <div>
            <Card className="p-1">
                <CardHeader>
                    <CardTitle className="text-dark font-weight-bold" tag='h2'>New Costing From: CO-9845</CardTitle>
                </CardHeader>
                <CardBody>
            ...
            <CostingDecisionModal
                openModal={decisionModalOpen}
                setOpenModal={setDecisionModalOpen}
            />
        </div >
    );
};

export default CostingAddFormFromExiting;
