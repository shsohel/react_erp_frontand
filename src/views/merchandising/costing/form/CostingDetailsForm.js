...
const CostingDetailsForm = () => {
    ...
    console.log( costingFabricDetails );
            ...
            </Nav>
            {
                active === '1' && <div>
                    ...
                    <Button.Ripple
                        id="addFabId"
                        tag={Label}
                        onClick={() => { handleAddFabricRow( costingFabricDetails.length ); }}
                        className='btn-icon'
                        color='flat-success'
                    >
            ...
            }
            {
                active === '2' && <div>
                    ...
                    <Button.Ripple
                        id="addAccId"
                        tag={Label}
                        onClick={() => { handleAddAccessoriesRow( costingAccessoriesDetails.length ); }}
                        className='btn-icon'
                        color='flat-success'
                    >
