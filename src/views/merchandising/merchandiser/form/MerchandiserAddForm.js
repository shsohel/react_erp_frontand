...
import { addMerchandiser, bindMerchandiserBasicInfo, merchandiserImageUpload } from "../store/actions";
...
const MerchandiserAddForm = ( { open, toggleSidebar } ) => {
    ...
    const onSubmit = () => {
        ...
        dispatch( addMerchandiser( submitObj ) );
                    ...
                    <Col>
                        <FormGroup>
                            ...
                            <Select
                                ...
                                className={classnames( `erp-dropdown-select ${( errors && errors.role && !merchandiserBasicInfo?.role ) && 'is-invalid'}` )}
                                value={merchandiserBasicInfo?.role}
                                onChange={( data, e ) => {
