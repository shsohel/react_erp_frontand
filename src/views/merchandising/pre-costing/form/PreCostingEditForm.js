...
import { Badge, Button, Card, CardBody, Col, Form, FormFeedback, FormGroup, InputGroup, InputGroupAddon, InputGroupText, Label, NavItem, NavLink, Row, Table } from 'reactstrap';
...
import CmCalculationForEdit from './CmCalculationForEdit';
import PreCostingDetailsForEdit from './PreCostingDetailsForEdit';
...
const PreCostingEditForm = ( { history } ) => {
    ...
    return (
        <div>
            <Card className="p-1 mt-3">
                {/* <CardHeader>
                    <CardTitle className="text-dark font-weight-bold" tag='h2'>Edit Pre-Costing</CardTitle>
                </CardHeader> */}
                <CardBody>
                        ...
                        <Row className="border rounded rounded-3 ">
                            ...
                            <FormGroup tag={Col} xs={12} sm={12} md={6} lg={3} xl={3} >
                                ...
                                <Input
                                    id='buyerId'
                                    type='text'
                                    defaultValue={styles?.buyer?.buyerName}
                                    readOnly
                                    name='buyerName'
                                />
                            </FormGroup>
                            ...
                            <FormGroup tag={Col} xs={12} sm={12} md={6} lg={3} xl={3} >
                                ...
                                <CmCalculationForEdit openModal={openModal} setOpenModal={setOpenModal} />
                            </FormGroup>
                            <FormGroup tag={Col} xs={12} sm={12} md={6} lg={3} xl={3} >
...
export default PreCostingEditForm;
