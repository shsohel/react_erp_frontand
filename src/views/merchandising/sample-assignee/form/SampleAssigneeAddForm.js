...
import { addSampleAssignee, bindSampleAssigneeBasicInfo, sampleAssigneeImageUpload } from "../store/actions";
...
const SampleAssigneeAddForm = ( { open, toggleSidebar } ) => {
    ...
    const onSubmit = () => {
        const submitObj = {
            ...
            image: sampleAssigneeBasicInfo.image
        };
        console.log( 'submitObj', JSON.stringify( submitObj, null, 2 ) );
        dispatch( addSampleAssignee( submitObj ) );
                    ...
                    <div className="main-div">
                        <Card className="img-holder">
                            {isSampleAssigneeImageUploading ? <div
                                ...
                                src={
                                    sampleAssigneeBasicInfo.imageEditUrl.length ? `${sampleAssigneeBasicInfo.imageEditUrl}` : defaultImage
                                }
                                alt="Buyer Image"
                                className="image"
                            />
                            ...
                            {sampleAssigneeBasicInfo?.imageEditUrl.length ? (
