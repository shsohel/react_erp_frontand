...
import { bindConsumptionFabricDetails, bindConsumptionSizeColorSense } from '../store/actions';
                                            ...
                                            <CreatableSelect
                                                ...
                                                onFocus={() => {
                                                    handleColorSegmentValueSingleOnFocus(
                                                        ...
                                                        consumptionDetailsColorSens.segmentId, colorSegmentValueDropdown );
                                                }}
                                                                ...
                                                                <CreatableSelect
                                                                    ...
                                                                    onFocus={() => {
                                                                        handleColorSegmentValueOnFocus( consumptionDetailsColorSens.categoryId,
                                                                            consumptionDetailsColorSens.segmentId, colorSegmentValueDropdown, i.randomGenerateId );
                                                                    }}
