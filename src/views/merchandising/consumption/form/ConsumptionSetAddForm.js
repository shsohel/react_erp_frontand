...
import { addSetConsumption, bindConsumptionAccessoriesDetails, bindConsumptionBasicInfo, cleanAllConsumptionState, getSetConsumptionStylePurchaseOrderDetails } from '../store/actions';
...
const ConsumptionSetAddForm = () => {
    ...
    const onSubmit = () => {
        ...
        dispatch( addSetConsumption( submittedObj, push ) );
    };
    const handleCancel = () => {
    ...
    return (
        <div>
            <Card className="mt-3">
                <CardBody>
                    <ActionMenu breadcrumb={breadcrumb} title='New Set Consumption' >
                                                        ...
                                                        <tbody className='text-center' >
                                                            {
                                                                consumptionBasicInfo?.styleOrderDetails?.map( ( cph, index ) => (
                                                                    <tr key={cph.rowId}>
                                                                        ...
                                                                        <td>{moment( cph.shipmentDate ).format( 'DD-MM-YYYY' )}</td>
                                                                    </tr>
                                                                ) )
                                                            }
...
export default ConsumptionSetAddForm;