...
const ConsumptionAddForm = () => {
    ...
    const handleSubmit = () => {
        const fabricDetails = fabricWithSubGroupRowNo.filter( f => f.isRowEditableState ).map( fabric => ( {
            ...
            itemDescription: fabric.itemDescription ? fabric.itemDescription.trim() : '',
            ...
            consumptionPerGarmentUom: fabric?.consumptionPerGarmentUomValue?.label,
        ...
        const accessoriesDetails = accessoriesWithSubGroupRowNo.filter( a => a.isRowEditableState ).map( accessories => ( {
            ...
            itemDescription: accessories.itemDescription ? accessories.itemDescription.trim() : '',
            ...
            consumptionPerGarmentUom: accessories.consumptionPerGarmentUomValue?.label,
...
export default ConsumptionAddForm;
