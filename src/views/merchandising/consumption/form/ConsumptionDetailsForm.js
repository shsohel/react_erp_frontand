...
const ConsumptionDetailsForm = () => {
    ...
    const handleItemGroupDropdownForFabric = async ( newValue, fieldId ) => {
        ...
        const updatedData = consumptionFabricDetails.map( i => {
            if ( fieldId === i.fieldId ) {
                ...
                i.hasAnyColorSensitivity = newValue?.hasAnyColorSensitivity;
                i.hasAnySizeSensitivity = newValue?.hasAnySizeSensitivity;
            }
            return i;
        } );
    ...
    const handleAddFabricRow = () => {
        ...
        const newRow = {
            ...
            hasAnyColorSensitivity: false,
            hasAnySizeSensitivity: false,
                                ...
                                columns={[
                                    ...
                                    },
                                    {
                                        ...
                                        cell: ( row, index ) => ( row?.isNew ? <Select
                                            ...
                                            menuPosition={'fixed'}
                                            options={_.sortBy( row.itemSubGroupArray, 'label' )}
                                            classNamePrefix='dropdown'
                                            className="erp-dropdown-select w-100"
