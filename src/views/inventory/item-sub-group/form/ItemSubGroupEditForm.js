...
import { updateItemSubGroup } from '../store/actions';

const ItemSubGroupEditForm = ( { open, toggleSidebar, data } ) => {
            ...
            <Form onSubmit={handleSubmit( onSubmit )}>
                ...
                <FormGroup>
                    ...
                    <Input
                        ...
                        id='itemSubGroupName'
                        defaultValue={data?.itemSubGroupName}
...
export default ItemSubGroupEditForm;
