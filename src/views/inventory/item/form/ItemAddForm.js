...
import { addItem, bindItemBasicInfo } from '../store/actions';

const itemBasicInfoDefaultValue = {
    itemGroup: null,
    itemGroupId: 0,
    itemSubGroup: null,
    itemSubGroupId: 0,
                ...
                <Form >
                    ...
                    <FormGroup>
                        ...
                        <Select
                            ...
                            onFocus={() => { handleItemSubGroupOnFocus( itemBasicInfo.itemGroup?.value ); }}
                        />
                    ...
                    <FormGroup>
                        ...
                        <InputGroup>
                            <Input
                                ...
                                className={classnames( ` ${( errors && errors.name && !itemBasicInfo.name.length ) && 'is-invalid'}` )}
                            ...
                            {errors && errors.name && !itemBasicInfo.name.length && <FormFeedback>{errors.name.message}</FormFeedback>}
