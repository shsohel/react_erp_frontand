...
import { permissibleProcessObj, procurementStatus, selectPayTerm, selectPurchaser, selectPurpose, selectShipmentMode, selectTerm, source } from '../../../../utility/enums';
...
import { bindPiBasicInfo, bindProcurementItems, bindSelectedProcurementItems, bindSelectedSupplierOrders, bindSupplierOrderOnChange, getPiById, getProcurementItemsByOrdersId, getSupplierOrders, updatePi } from '../store/actions';
...
const PiEditForm = () => {
    ...
    const handleBasicInfoDropdownChange = ( data, e ) => {
        ...
        if ( name === 'supplier' ) {
            ...
            dispatch( getSupplierOrders( piBasicInfo.buyer?.value, piBasicInfo.supplier?.value ) );
    ...
    const onSubmit = () => {
        ...
        const submitObj = {
            ...
            status: piBasicInfo?.updateStatus?.label,
        ...
        if ( submitObj.orderDetails.length ) {
            if ( !isValidatedArray() ) {
                dispatch( updatePi( submitObj, piId, piBasicInfo?.updateStatus?.label, push ) );
            } else {
    ...
    return (
        <div>
            <ActionMenu breadcrumb={breadcrumb} title='EDIT IPI' >
                                    ...
                                    <Row>
                                        ...
                                        <Col xs={12} sm={12} md={12} lg={3} xl={3} >
                                            <div className='custom-form-main'>
                                                ...
                                                <Label className='custom-form-colons'> : </Label>
                                                <div className='custom-form-group'>
                                                    {piBasicInfo?.approveDate ? moment( piBasicInfo?.approveDate ).format( "DD/MM/YYYY" ) : ''}
                                                </div>
                                            </div>
                                        </Col>
                                    </Row>
