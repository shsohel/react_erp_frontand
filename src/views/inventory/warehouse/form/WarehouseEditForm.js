...
import { bindWarehouseDataOnchange, getWarehouseById, updateWarehouse } from '../store/actions';
...
const WarehouseEditForm = () => {
    ...
    const SignupSchema = yup.object().shape( {
        ...
        // tags: warehouse?.tags.length ? yup.string() : yup.string().required( 'Tags is Required!!' )
    ...
    const onSubmit = () => {
        ...
        dispatch( updateWarehouse( submitObj, warehouseId ) );
    };
    ...
    return (
        <div>
            <ActionMenu breadcrumb={breadcrumb} title='Edit Warehouse' >
                                            ...
                                            {/* <div className='custom-form-main'>
                                                ...
                                                <div className='custom-form-group'>
                                                    <CreatableSelect
                                                        ...
                                                        classNamePrefix='dropdown'
                                                        // innerRef={register( { required: true } )}
                                                        className={classnames( `erp-dropdown-select ${( errors && errors.tags && !warehouse?.tags.length ) && 'is-invalid'}` )}
                                                        value={warehouse?.tags}
                                                        onChange={( data, e ) => {
                                                            handleBasicInfoDropdownChange( data, e );
                                                        }}
                                                    />
